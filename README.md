...
* BlueMuse가 설치되어 있지 않다면 GUI의 **BlueMuse 설치/업데이트** 버튼을 눌러 최신 [GitHub 릴리스](https://github.com/kowalej/BlueMuse/releases)를 자동으로 내려받아 설치합니다.
...
2. **BlueMuse 연동** 섹션에서 다음 작업을 수행합니다.
   * BlueMuse가 없다면 **BlueMuse 설치/업데이트** 버튼을 눌러 설치 프로그램을 실행합니다. 설치 마법사가 종료되면 GUI가 자동으로 실행 파일 경로를 갱신합니다.
